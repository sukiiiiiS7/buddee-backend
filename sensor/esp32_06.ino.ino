...
String deviceID = "ESP32-06";  // Change this for each device e.g. ESP32-04
...
void loop() {
    ...
    if (avgMoisture > 400 && avgMoisture < 4000) {
        digitalWrite(PUMP_PIN, HIGH); //make plant wet
        delay(3000);
        digitalWrite(PUMP_PIN, LOW); //stop
    }
